...
print(Person(name='anggi', age=31, height=180, email='test@gmail.com', house_coordinats=(1, 2)))
...
anggi = Person(name='anggi', age=31, height=180, email='test@email.com', house_coordinats=(1, 2))
permana = Person(name='permana', age=30, height=155, email='test2@email.com', house_coordinats=(3, 4))
